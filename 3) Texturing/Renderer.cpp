...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	...
	SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0);						//LOAD TEXTURE
	
	if (!texture) {
		return;
	}

	shader = new Shader("TexturedVertex.glsl", "TexturedFragment.glsl"); //SETS SHADERS
...
//Switches between bilenear and nearest neighbour filtering
