...
//Returns a pointer to a mesh with in its VAO and VBO thatr will draw a colored triangle
 Mesh * Mesh::GenerateTriangle() {
	...
	m -> textureCoords = new Vector2[m -> numVertices];	//TEXTURING COORDINATES
	m -> textureCoords[0] = Vector2(0.5f, 0.0f);
	m -> textureCoords[1] = Vector2(1.0f, 1.0f);
	m -> textureCoords[2] = Vector2(0.0f, 1.0f);	//END TEX COORDS
